...
wvSelectSignal -win $_nWave2 {( "G2/router_if(router_io)" 5 )} 
wvSelectSignal -win $_nWave2 {( "G2/router_if(router_io)" 5 )} 
wvSetPosition -win $_nWave2 {("G2/router_if(router_io)" 5)}
wvExpandBus -win $_nWave2
wvSetPosition -win $_nWave2 {("G2/router_if(router_io)" 40)}
